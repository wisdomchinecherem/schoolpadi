      ...
      <div className="relative mt-4 px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 z-10">
          ...
          <div className="relative bg-white rounded-lg shadow-md p-4">
            ...
            <p className="text-2xl mt-4">34</p>
            <div className="absolute bottom-0 right-0">
              <div className="bg-black text-white rounded-full p-2.5">
                <FontAwesomeIcon icon={faUser} className="text-xs" />
              </div>
          ...
          {/* Card 3 */}
          <div className="relative bg-white rounded-lg shadow-md p-4">
            <h2 className="text-sm font-bold">Non-Teaching</h2>
          ...
          <div className="relative bg-white rounded-lg shadow-md p-4">
            ...
            <p className="text-2xl mt-4">567</p>
            <div className="absolute bottom-0 right-0">
              <div className="bg-black text-white rounded-full p-2.5">
                <FontAwesomeIcon icon={faUser} className="text-xs" />
              </div>
          ...
          {/* Card 5 */}
          <div className="relative bg-white rounded-lg shadow-md p-4">
            <h2 className="text-sm font-bold">Total No. of Classes</h2>
            <p className="text-2xl mt-4">22</p>
            <div className="absolute bottom-0 right-0">
              <div className="bg-black text-white rounded-full p-2.5">
                <FontAwesomeIcon icon={faUser} className="text-xs" />
              </div>
          ...
          <div className="relative bg-white rounded-lg shadow-md p-4">
            ...
            <p className="text-2xl mt-4">1500k</p>
            <div className="absolute bottom-0 right-0">
              <div className="bg-black text-white rounded-full p-2.5">
                <FontAwesomeIcon icon={faUser} className="text-xs" />
              </div>
