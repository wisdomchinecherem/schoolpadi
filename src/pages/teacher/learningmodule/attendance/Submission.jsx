...
const Submission = () => {
  ...
  const data = [
    { date: '01-07-2024', section: 'Section A', class: 'Class 3', subject: 'Mathematics', isMarked: true },
    { date: '02-07-2024', section: 'Section B', class: 'Class 1', subject: 'Science', isMarked: false },
    // More sample data...
  ];
            ...
            {filteredData.map((item, idx) => (
              <tr key={idx}>
                ...
                <td className="px-4 py-2 whitespace-nowrap">
                  <input type="checkbox" className="form-checkbox text-green-500" checked={item.isMarked} readOnly />
                </td>
              </tr>
            ))}
          </tbody>
