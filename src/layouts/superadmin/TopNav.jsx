...
export default function TopNav() {
  ...
  return (
    <div className="relative w-full bg-[#014F9E] text-white md:h-[55vh] xl:h-[50vh] 2xl:h-[40vh] py-8 px-[20px] md:px-[80px]">
      ...
      <div className="xl:flex flex-col gap-8 items-center my-10 justify-between">
