...
// import closeIcon from "../images/close.svg"; // Close icon for the side menu1
    ...
    >
      ...
      >
        ...
        <div
          ...
          onClick={handleClickedMobileLink}
        >
          {navItems.map((navItem) => (
            <div key={navItem.path}>
              <NavLink
                ...
                className={({ isActive }) =>
                  `relative flex font-medium text-sm py-2 cursor-pointer text-nowrap max-w-min items-center px-4 ${
                    isActive
                      ? "bg-white text-[#01356B] px-4 rounded-lg mb-2"
                      : "text-white"
                  }`
