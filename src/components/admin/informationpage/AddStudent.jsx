          ...
          <div className="rounded-[.625rem] flex flex-1 bg-white flex-col gap-8 mb-8 ">
            ...
            <div className="px-4 py-5 border rounded-[.625rem]">
              ...
              <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-7 ">
                ...
                <div className="flex-1 text-[#54585C] ">
                  <div className=" text-sm  ">Father’s Name</div>
                  <input
                    type="text"
                    name="Father’s Name"
                    placeholder="enter here"
                ...
                <div className="flex-1 text-[#54585C] ">
                  <div className=" text-sm  ">Mother’s Name</div>
                  <input
                    type="text"
                    name="Mother’s Name"
                    placeholder="enter here"
                ...
                <div className="flex-1 text-[#54585C] ">
                  <div className=" text-sm  ">Parent’s Contact</div>
                  <input
                    type="text"
                ...
                <div className="flex-1 text-[#54585C] ">
                  <div className=" text-sm  ">Parent’s Email</div>
                  <input
                    type="text"
                    name="Parent’s Email"
                    placeholder="enter here"
