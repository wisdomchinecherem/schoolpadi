...
import { FaUserEdit, FaEnvelope, FaSms, FaWhatsapp, FaLock, FaUnlock, FaTrash } from 'react-icons/fa'; 
import AttendanceTab from '../../teacher/administration/AttendanceTab'; 
        ...
        <div className="relative -top-4 px-6">
          <div className="bg-white rounded-lg shadow-lg mx-4 py-6 px-4 mb-4">
            <div className="grid grid-cols-4 gap-2">
              ...
              <a href="/AttendanceScreen" className="flex flex-col sm:flex-row items-center justify-center relative">
